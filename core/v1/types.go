...
type HotplugVolumeStatus struct {
	...
	// MountDirectory indicates whether to mount as a directory
	MountDirectory bool `json:"mountDirectory,omitempty"`
}
...
const (
	...
	// AttachPodNetwork indicates default tap interface attach to pod qemu network.
	AttachPodNetwork string = "kubevirt.io/attach-pod-network"
)

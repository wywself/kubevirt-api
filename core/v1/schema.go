...
type CloudInitConfigDriveSource struct {
	...
	// + optional
	NetworkData string `json:"networkData,omitempty"`
	// MetaData contains config drive inline cloud-init metadata.
	// + optional
	MetaData string `json:"metaData,omitempty"`
	// MetaDataBase64 contains config drive cloud-init metadata as a base64 encoded string.
	// + optional
...
type HotplugVolumeSource struct {
	...
	// +optional
	DataVolume *DataVolumeSource `json:"dataVolume,omitempty"`
	// BitmapVolume represents the dynamic creation a PVC for this volume as well as
